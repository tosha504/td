$(document).ready(function () {
  ...
  $('.shop__items_wrap a').on('click', function (e) {
    ...
    $.ajax({
      ...
      beforeSend: function beforeSend(response) {// $('.resp-box').addClass("loader");
        // if($('.rolls')) {
        //     $('.rolls').hide();
        // }
        // isAjaxActive = true;
      },
      complete: function complete(response) {// $('.resp-box').removeClass("loader");
      ...
      error: function error(jqXhr, textStatus, errorMessage) {// if(!$('.resp-box').hasClass("error")){
